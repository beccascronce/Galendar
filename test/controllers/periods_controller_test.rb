...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { end_date: @period.end_date, start_date: @period.start_date, user_id: @period.user_id } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { end_date: @period.end_date, start_date: @period.start_date, user_id: @period.user_id } }
